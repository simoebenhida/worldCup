  ...
  <div class="relative flex flex-col h-12">
    ...
    <div class="fixed mt-10 w-auto bg-white w-full mb-8">
      <div class="container mx-auto flex items-center border-b border-white py-2">  
            ...
            <div class="px-4">
              <a href="/now" class="no-underline text-blue-darker font-thin text-base hover:text-blue hover:border-blue border-b-2 border-transparent py-2 @if(!is_null(last_current_url()) && (last_current_url() == "now")) border-blue @endif">Now</a>
            </div>
            <div class="px-4">
              <a href="/today" class="no-underline text-blue-darker font-thin text-base hover:text-blue hover:border-blue border-white border-b-2 py-2 @if(!is_null(last_current_url()) && (last_current_url() == "today")) border-blue @endif">Today</a>
            </div>
            <div class="px-4">
              <a href="/tomorrow" class="no-underline text-blue-darker font-thin text-base hover:text-blue hover:border-blue border-white border-b-2 py-2 @if(!is_null(last_current_url()) && (last_current_url() == "tomorrow")) border-blue @endif">Tomorrow</a>
            </div>
            <div class="px-4">
              <a href="/yesterday" class="no-underline text-blue-darker font-thin text-base hover:text-blue hover:border-blue border-white border-b-2 py-2 @if(!is_null(last_current_url()) && (last_current_url() == "yesterday")) border-blue @endif">Yesterday</a>
            </div>
      </div>
      </div>
  </div>
    ...
    <div class="container mx-auto mt-10">
        <div class="border-b border-blue-darker py-6">
            <h1 class="font-bold text-3xl text-blue-darker">MATCHES</h1>
                            ...
                            <!--     <div class="flex px-2">
              <div class="font-hairline flex flex-col text-center text-xs py-2 text-white leading-normal tracking-wide px-4">
                  <span>Corners : 7</span>
                  <span>Tackles : 8</span>
                  <span>Red cards : 0</span>
                  <span>Number passes : 387</span>
                  <span>Ball possession : 47 %</span>
                  <span>Goal Attempts : 12</span>
                  <span>Passes Completed : 282</span>
                </div>
              <div class="font-hairline flex flex-col text-center py-2 text-xs text-white leading-normal tracking-wide px-4">
                  <span>Corners : 7</span>
                  <span>Tackles : 8</span>
                  <span>Red cards : 0</span>
                  <span>Number passes : 387</span>

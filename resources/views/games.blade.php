                ...
                <div class="bg-white py-4 px-2 md:px-4 border-b-4 border-grey">
                    <div class="lg:flex">
                        <div class="md:flex w-full lg:w-2/3 ">
                            <div class="lg:w-1/4 mb-2 py-2 flex flex-col font-hairline text-xs text-grey-darker leading-normal">
                                <!-- <span>Group A</span> -->
                            ...
                            <div class="w-full flex justify-center">
                                <div class="w-1/3 px-2 mb-2">
                                    ...
                                    <div class="font-hairline flex flex-col text-center py-2 text-xs text-grey-darker leading-normal tracking-wide">
                                ...
                                <div class="w-1/4 flex flex-col items-center mb-2">
                                    <p class="font-hairline text-xs md:text-lg text-grey-darker">{{ strtoupper($game->time) }}</p>
                                    <p class="font-black font-mono text-xs md:text-lg text-grey-darker">{{ $game->home_team['goals'] }} - {{ $game->away_team['goals'] }}</p>
                                </div>

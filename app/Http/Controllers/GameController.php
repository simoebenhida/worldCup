...
class GameController extends Controller
{
    ...
    public function data($item) : array
    {
        return [
            ...
            'home_team_events' => array_key_exists('home_team_events', $item) ? json_encode($item['home_team_events']) : null,
            'away_team_events' => array_key_exists('away_team_events', $item) ? json_encode($item['away_team_events']) : null,
            'home_team_statistics' => array_key_exists('home_team_statistics', $item) ? json_encode($item['home_team_statistics']) : null,
            'away_team_statistics' => array_key_exists('away_team_statistics', $item) ? json_encode($item['away_team_statistics']) : null,
            'winner' => $item['winner'],
